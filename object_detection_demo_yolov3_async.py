...
def main():
    ...
    args.input = 'outdoors02.avi'
    args.prob_threshold = 0.5
    args.iou_threshold = 0.4
    ...
    while cap.isOpened():
        ...
        for obj in objects:
            ...
            # roi_width = obj['xmax']-obj['xmin']
            # roi_height = obj['ymax']-obj['ymin']
            # roi_width = wmax - wmin
            # roi_height = hmax - hmin
            roi_width = 400
            roi_height = 400
        ...
        if not args.no_show:
            ...
            print(roi_width)
            print(roi_height)
            cv2.resizeWindow("crop_image", roi_width, roi_height)
