...
void update_state()
{
    ...
    if (check == pkg_tmp[36])
    {
        ...
        ROS_INFO("ENU X: %4.4f  Y:%4.4f vX: %4.4f  vY:%4.4f yaw: %4.4f", enu_xyz[0], enu_xyz[1], enu_vxyz[0], enu_vxyz[1],yaw);
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    //订阅主题，并配置回调函数
    read_pub = nh.advertise<nav_msgs::Odometry>("/car_pos_vel_topic", 1);
