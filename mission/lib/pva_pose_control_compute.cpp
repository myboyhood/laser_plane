...
void mission_core::pva_tracker_control() {
    Vector3d goal_p(car_pos_from_start[0] + carToDroneDistanceEnu[0] - distance_car_drone[0]*cos(yaw_rotate),car_pos_from_start[1] + carToDroneDistanceEnu[1]- distance_car_drone[1]*sin(yaw_rotate),home_hover_height);
