...
void mission_core::px4_traj_track_control(){
    ...
    while(ros::ok()){
        ...
        px4_waypoint_calculate(curr_p, Vector3d(car_pos[0]+car_pos_bias[0]-distance_car_drone*cos(yaw_rotate),car_pos[1]+car_pos_bias[1]-distance_car_drone*sin(yaw_rotate),car_pos[2]));
